<div class="row">
    <div class="col-md-12">
        <form method="post" action="<?php echo base_url() ?>client/mailbox/delete_mail/sent/trash">
                                        ...
                                        <div class="mb-mail-meta">
                                            <div class="pull-left">
                                                <div class="mb-mail-subject"><a
                                                        href="<?php echo base_url() ?>client/mailbox/index/read_send_mail/<?php echo $v_sent_msg->sent_id ?>"><?= $subject ?></a>
                                                </div>
