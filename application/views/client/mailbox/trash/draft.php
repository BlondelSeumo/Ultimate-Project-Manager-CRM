<div class="row">
    <div class="col-md-12">
        <form method="post" action="<?php echo base_url() ?>client/mailbox/delete_mail/draft/trash">
                                        ...
                                        <div class="mb-mail-meta">
                                            <div class="pull-left">
                                                <div class="mb-mail-subject"><a
                                                        href="<?php echo base_url() ?>client/mailbox/index/compose/<?php echo $v_draft_msg->draft_id ?>"><?= $subject ?></a>
                                                </div>
