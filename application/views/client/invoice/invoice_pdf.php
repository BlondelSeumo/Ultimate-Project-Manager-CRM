        ...
        <td class="">
            ...
            <div class="right" style="float: right;padding-right: 20px">
                ...
                <div class="date"><?= $language_info['invoice_date'] ?>
                    :
                    <span style="text-align: right"><?= strftime(config_item('date_format'), strtotime($invoice_info->invoice_date)); ?></span>
                </div>
                <div class="date"><?= $language_info['due_date'] ?>
                    :
                    <span style="text-align: right"><?= strftime(config_item('date_format'), strtotime($invoice_info->due_date)); ?></span>
                </div>
...
<table class="items">
    ...
    <?php
    $refund_amount = $this->invoice_model->calculate_to('refund_amount', $invoice_info->invoices_id);
    if ($refund_amount > 0): ?>
        <tr class="total">
            <td colspan="<?= $colspan ?>"></td>
