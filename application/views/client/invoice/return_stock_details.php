...
<div class="row mb">
    <div class="col-sm-2 pull-right">
        ...
        <a href="<?= base_url() ?>client/invoice/pdf_return_stock/<?= $return_stock_info->return_stock_id ?>"
            ...
            <div class="col-lg-6 col-xs-6 ">
                <div class="pull-right pr-lg">
                    ...
                    <?php if (!empty($return_stock_info->invoices_id)) {
                        ...
                        ?>
                        <strong class="mb0 block"><?= lang('invoice') . ' ' . lang('no') . ' : <a href="' . base_url("client/invoice/manage_invoice/invoice_details/$return_stock_info->invoices_id") . '">' . $inv_info ?></a></strong>
                    <?php } ?>
                    ...
                    ?>
                    <br><?= lang('status') ?>: <span
                            class="label label-<?= $label ?>"><?= lang($return_stock_info->main_status) ?></span>
