<div class="row">
    <div class="col-md-12">
        <form method="post" action="<?php echo base_url() ?>admin/mailbox/delete_mail/inbox/trash">
            <!-- Main content -->
                        ...
                        <table class="table table-hover mb-mails">
                            ...
                            <?php if (!empty($get_inbox_message)):foreach ($get_inbox_message as $v_inbox_msg): ?>
                                <tr>
                                    ...
                                    <td>
                                        <div
                                            class="mb-mail-date pull-right"><?= time_ago($v_inbox_msg->message_time); ?>
                                            <a class="btn btn-primary btn-xs"
                                               href="<?php echo base_url() ?>admin/mailbox/restore/inbox/<?php echo $v_inbox_msg->inbox_id ?>"
                                               data-toggle="tooltip" data-placement="top" title="Restore"><i
                                                    class="fa fa-retweet"></i></a>
                                            <a class="btn btn-danger btn-xs"
                                               href="<?php echo base_url() ?>admin/mailbox/delete_mail/inbox/deleted/<?php echo $v_inbox_msg->inbox_id ?>"
                                        ...
                                        <div class="mb-mail-meta">
                                            ...
                                            <div class="mb-mail-preview">
                                                <?php
                                                $body = (strlen($v_inbox_msg->message_body) > 100) ? strip_html_tags(mb_substr($v_inbox_msg->message_body, 0, 100)) . '...' : $v_sent_msg->message_body;
                                                echo $body;
