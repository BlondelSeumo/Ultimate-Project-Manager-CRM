                    ...
                    <div class="box-shadow">
                        <div class="col-sm-12 p0">
                            <p style="border-bottom: 1px solid #e4e5e0;">
                                <a href="<?= base_url() ?>admin/tasks/attachment_details/g/<?= $files_info[$key]->task_attachment_id ?>"
                                ...
                                <a data-toggle="tooltip" data-placement="top"
                                   ...
                                   href="<?= base_url() ?>admin/tasks/download_all_files/<?= $files_info[$key]->task_attachment_id ?>"
                                   class="pull-right"><i
                                        class="fa fa-cloud-download"></i></a>
                                <?php if ($files_info[$key]->user_id == $this->session->userdata('user_id')) { ?>
                                    <small class="pull-right">
                                        <?php echo ajax_anchor(base_url("admin/tasks/delete_task_files/" . $files_info[$key]->task_attachment_id), "<i class='text-danger fa fa-trash-o'></i>", array("class" => "", "title" => lang('delete'), "data-fade-out-on-success" => "#attachment_container-" . $files_info[$key]->task_attachment_id)); ?>
                                    </small>
                                <?php } ?>
                                        ...
                                        <div class="col-sm-6 p0 pr-sm mb-sm">
                                            ...
                                            <?php if ($l_key == 3) {
                                                ...
                                                if (!empty($more)) {
                                                    ...
                                                    data-toggle="modal"
                                                    data-target="#myModal_extra_lg"
                                                    href="<?= base_url() ?>admin/tasks/attachment_details/g/<?= $files_info[$key]->task_attachment_id ?>">
                                                    <span
