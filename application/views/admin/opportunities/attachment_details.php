    ...
    <div class="panel-heading">
        ...
        <h4 class="panel-title" id="myModalLabel"><?= $title . '-' . lang('details') ?>
            <a data-toggle="tooltip" data-placement="top"
               ...
               href="<?= base_url() ?>admin/opportunities/download_all_files/<?= $attachment_info->task_attachment_id ?>"
               class="pull-right"><i
                                    ...
                                    <?php } else { ?>
                                        <div class="no-preview">
                                            ...
                                            <strong><a style="color: #fff"
                                                       href="<?= base_url() ?>admin/opportunities/download_files/<?= $attachment_info->project_id ?>/<?= $v_files->uploaded_files_id ?>"> <?= $v_files->file_name ?></a></strong>
                                                </span>

                                            <a href="<?= base_url() ?>admin/opportunities/download_files/<?= $attachment_info->project_id ?>/<?= $v_files->uploaded_files_id ?>"
                                               class="pull-right"><i
