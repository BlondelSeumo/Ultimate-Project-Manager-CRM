    ...
    <tr>
        ...
        <td style="width: 50%;">
            <div class="right" style="">
                <h2 style="margin-bottom: 0"><?= lang('credit_note') ?>
                    : <?= $credit_note_info->reference_no ?></h2>
                <div class="date"><?= lang('credit_note_date') ?>
                    :<?= strftime(config_item('date_format'), strtotime($credit_note_info->credit_note_date)); ?></div>
                <?php
                ...
                <div class="date"><?= lang('status') ?>: <?= lang($credit_note_info->status) ?></div>
...
<table class="items">
    ...
    <tr class="total">
        ...
        <td><?= display_money($this->credit_note_model->credit_note_calculation('credit_note_cost', $credit_note_info->credit_note_id)) ?></td>
    </tr>
    <?php if ($credit_note_info->discount_total > 0): ?>
        <tr class="total">
            <td colspan="<?= $colspan ?>"></td>
            <td colspan="1"><?= $language_info['discount'] ?>(<?php echo $credit_note_info->discount_percent; ?>%)</td>
            <td> <?= display_money($this->credit_note_model->credit_note_calculation('discount', $credit_note_info->credit_note_id)) ?></td>
        </tr>
    <?php endif;
    ...
    <?php endif;
    if ($credit_note_info->adjustment > 0): ?>
        <tr class="total">
            <td colspan="<?= $colspan ?>"></td>
            <td colspan="1"><?= $language_info['adjustment'] ?></td>
            <td><?= display_money($credit_note_info->adjustment); ?></td>
        </tr>
    <?php endif ?>
    <tr class="total">
        <td colspan="<?= $colspan ?>"></td>
...
<div id="notices">
    <div class="notice"><?= strip_html_tags($credit_note_info->notes, true) ?></div>
</div>
<?php
$invoice_view = config_item('invoice_view');
...
<?php } ?>
<footer>
    <?= config_item('credit_note_footer') ?>
</footer>
</body>
</html>
