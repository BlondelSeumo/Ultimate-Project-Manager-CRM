    ...
    <div class="panel-heading">
        ...
        <h4 class="panel-title" id="myModalLabel"><?= $title . '-' . lang('details') ?>
            <a data-toggle="tooltip" data-placement="top"
               ...
               href="<?= base_url() ?>admin/bugs/download_all_files/<?= $attachment_info->task_attachment_id ?>"
               class="pull-right"><i
                ...
                <div class="col-md-5 pr0">
                    <div class="panel panel-custom">
                        ...
                        <div class="panel-body chat" id="chat-box">
                            <?php echo form_open(base_url("admin/bugs/save_attachment_comments"), array("id" => $comment_type . "-comment-form", "class" => "form-horizontal", "enctype" => "multipart/form-data", "role" => "form")); ?>
                            <?php if ($type == 'g') { ?>
