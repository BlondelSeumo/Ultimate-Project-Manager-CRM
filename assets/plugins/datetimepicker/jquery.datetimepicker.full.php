<script type="text/javascript">
    ...
    (function () {
        ...
        defaultSettings = {
            dateSettings: {
                days: ["<?= lang('Sunday')?>", "<?= lang('Monday')?>", "<?= lang('Tuesday')?>", "<?= lang('Wednesday')?>", "<?= lang('Thursday')?>", "<?= lang('Friday')?>", "<?= lang('Saturday')?>", "<?= lang('Sunday')?>"],
                daysShort: ["<?= lang('Sun')?>", "<?= lang('Mon')?>", "<?= lang('Tue')?>", "<?= lang('Wed')?>", "<?= lang('Thu')?>", "<?= lang('Fri')?>", "<?= lang('Sat')?>", "<?= lang('Sun')?>"],
                daysMin: ["<?= lang('Su')?>", "<?= lang('Mo')?>", "<?= lang('Tu')?>", "<?= lang('We')?>", "<?= lang('Th')?>", "<?= lang('Fr')?>", "<?= lang('Sa')?>", "<?= lang('Su')?>"],
