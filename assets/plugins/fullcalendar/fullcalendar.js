        ...
        /***/ (function (module, exports, __webpack_require__) {
            ...
            var InteractiveDateComponent = /** @class */ (function (_super) {
                ...
                InteractiveDateComponent.prototype.canStartSelection = function (seg, ev) {
                    return util_1.getEvIsTouch(ev) && !this.canStartResize(seg, ev) &&
            ...
            var EventDragging = /** @class */ (function (_super) {
                ...
                EventDragging.prototype.buildSelectListener = function (seg) {
                    ...
                    var dragListener = this.dragListener = new DragListener_1.default({
                        dragStart: function (ev) {
                            if (dragListener.isTouch && !view.isEventDefSelected(eventDef) &&
                                eventInstance) {
        ...
        /***/ (function (module, exports, __webpack_require__) {
            ...
            var EventManager = /** @class */ (function () {
                ...
                EventManager.prototype.requestEvents = function (start, end, timezone, force) {
                    if (force || !this.currentPeriod || !this.currentPeriod.isWithinRange(start, end) ||
...
// A cmp function for determining the leftmost event
        ...
        /***/ (function (module, exports, __webpack_require__) {
            ...
            BootstrapTheme.prototype.classes = {
                ...
                popover: 'panel panel-custom',
                popoverHeader: 'panel-heading',
                popoverContent: 'panel-body',
                // day grid
                headerRow: 'panel-custom',
                dayRow: 'panel-custom',
                // list view
                listView: 'panel panel-custom'
            };
