<script type="text/javascript">
    ...
    (function ($, undefined) {
        ...
        var defaults = {
            ...
            monthNamesShort: ["<?= lang('Jan')?>", "<?= lang('Feb')?>", "<?= lang('Mar')?>", "<?= lang('Apr')?>", "<?= lang('May')?>", "<?= lang('Jun')?>", "<?= lang('Jul')?>", "<?= lang('Aug')?>", "<?= lang('Sept')?>", "<?= lang('Oct')?>", "<?= lang('Nov')?>", "<?= lang('Dec')?>"],
...
// function for adding/overriding defaults
        ...
        function Calendar(element, options, eventSources) {
            ...
            function initialRender() {
                ...
                content = $("<div class='fc-content' style='position:relative;min-height: 1px;'/>")
                    .prependTo(element);
                ...
                if (buttonStr) {
                    $.each(buttonStr.split(' '), function (i) {
                        ...
                        $.each(this.split(','), function (j, buttonName) {
                            if (buttonName == 'title') {
                                e.append("<h2 class='fc-header-title'>&nbsp;</h2>");
                                e.append("<h5 title='Add Event'  class='fc-header-title' style='margin-left:120px;'>\n\
                            <a href='admin/dashboard' data-toggle='modal' data-target='#event_modal' >\n\
                             </a> &nbsp;</h5>");
                                prevButton = null;
                            } else {
                                var buttonClick;
                                ...
                                if (buttonClick) {
                                    ...
                                    var button = $(
                                        "<span class='fc-button-" + buttonName + " " + tm + "-state-default'>" +
                                        (icon ?
