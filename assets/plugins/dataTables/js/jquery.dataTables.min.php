<script type="text/javascript">
    ...
    (function (h) {
        ...
        function Fa(a) {
            ...
            !a.sEmptyTable && (c && "<?= lang('no_data_available')?>" === b.sEmptyTable) && F(a, a, "sZeroRecords", "sEmptyTable");
            !a.sLoadingRecords && (c && "<?= lang('loading')?>" === b.sLoadingRecords) && F(a, a, "sZeroRecords", "sLoadingRecords");
        ...
        m.defaults = {
            ...
            oLanguage: {
                oAria: {
                    sSortAscending: ": <?= lang('activate_to_sort_column_ascending')?>",
                    sSortDescending: ": <?= lang('activate_to_sort_column_descending')?>"
                },
                oPaginate: {
                    sFirst: "<?= lang('first')?>",
                    sLast: "<?= lang('last')?>",
                ...
                sEmptyTable: "<?= lang('no_data_available')?>",
                ...
                sInfoFiltered: "(<?= lang('filtered_from')?> _MAX_ <?= lang('total')?> <?= lang('entries')?>)",
                sInfoPostFix: "",
                sDecimal: "",
                sThousands: ",",
                ...
                sSearchPlaceholder: "",
                sUrl: "",
                sZeroRecords: "<?= lang('no_macthing_found')?>"
            },
            oSearch: h.extend({},
                m.models.oSearch),
            sAjaxDataProp: "data",
